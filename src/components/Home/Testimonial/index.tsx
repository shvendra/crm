...
const Testimonial = () => {
  ...
  <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4">
    ...
    <p className="text-base text-center text-muted dark:text-white/60 lg:max-w-[60%] mx-auto">
      Hear from employers who trust BookMyWorker for their workforce needs.
      From construction sites and factories to warehouses and farms, businesses
      across industries rely on our platform to hire workers quickly, easily,
      and with confidence.
    </p>
