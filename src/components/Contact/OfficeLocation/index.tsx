        ...
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4">
          <div className="">
            <div className="grid md:grid-cols-6 lg:grid-cols-9 grid-cols-1 gap-7 border-b border-solid border-white/50 pb-11">
              ...
              <div className="col-span-3">
                <Link href="mailto:headoffice@BookMyWorker.com" className="sm:text-2xl text-xl text-white font-medium underline">headoffice@BookMyWorker.com</Link>
            ...
            <div className="grid md:grid-cols-6 lg:grid-cols-9 grid-cols-1 gap-7 pt-12">
              ...
              <div className="col-span-3">
                <Link href="mailto:office@BookMyWorker.com" className="sm:text-2xl text-xl text-white font-medium underline">office@BookMyWorker.com</Link>
